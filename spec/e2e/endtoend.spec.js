...
describe('Cordova create and build', function () {
    ...
    xit('spec.3a should build project for particular CPU', function () {
    ...
    xit('spec.4a should build project for CPUs separated by whitespaces', function () {
    ...
    xit('spec.5a should build project containing plugin with InProcessServer extension', function (done) {
    ...
    xit('spec.5b should build project (8.1) containing plugin with InProcessServer extension', function (done) {
        var extensionsPluginInfo, api;
    ...
    it('spec.6a should generate appxupload and appxbundle for Windows 10 project bundle release build (all target platforms)', function () {
        ...
        _expectExist(/.*bundle\.appxupload$/, 3);
        _expectSubdirAndFileExist('CordovaApp.Windows10_1.0.0.0_Test', 'CordovaApp.Windows10_1.0.0.0_x64.appxbundle'); // XXX THIS SHOULD FAIL
